...
export function AdminPageHeader({ actions, breadcrumbs, description, eyebrow, media, status, title }: AdminPageHeaderProps) {
  return (
    <header className="admin-page-header">
      <AdminBreadcrumbs items={breadcrumbs} />
      <div className="admin-page-header__row">
        <div className="admin-page-header__identity">
          {media && <div className="admin-page-header__media">{media}</div>}
